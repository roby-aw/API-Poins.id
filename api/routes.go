...
func RegistrationPath(e *echo.Echo, controller Controller) {
	...
	g.GET("/transaction/pending", controller.AdminControlller.TransactionPending, middleware.AdminSetupAuthenticationJWT())
	...
	g.GET("/transaction", controller.AdminControlller.TransactionByDate, middleware.AdminSetupAuthenticationJWT())
	g.PUT("/customer", controller.AdminControlller.UpdateCustomer, middleware.AdminSetupAuthenticationJWT())
	g.PUT("/customer/point", controller.AdminControlller.UpdateCustomerPoint, middleware.AdminSetupAuthenticationJWT())
	g.GET("/stock", controller.AdminControlller.StockProduct, middleware.AdminSetupAuthenticationJWT())
	g.PUT("/stock", controller.AdminControlller.UpdateStock, middleware.AdminSetupAuthenticationJWT())
	s := c.Group("/store")
